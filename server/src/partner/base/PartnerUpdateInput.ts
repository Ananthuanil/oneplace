...
class PartnerUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => OpportunityUpdateManyWithoutPartnersInput,
  })
  @ValidateNested()
  @Type(() => OpportunityUpdateManyWithoutPartnersInput)
  @IsOptional()
  @Field(() => OpportunityUpdateManyWithoutPartnersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ProjectUpdateManyWithoutPartnersInput,
  })
  @ValidateNested()
  @Type(() => ProjectUpdateManyWithoutPartnersInput)
  @IsOptional()
  @Field(() => ProjectUpdateManyWithoutPartnersInput, {
    nullable: true,
  })
